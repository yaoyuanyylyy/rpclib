...
#include <rpcpp/msgpack/predef/library/c/gnu.h>
#include <rpcpp/msgpack/predef/os/macos.h>
#include <rpcpp/msgpack/predef/os/bsd.h>
#include <rpcpp/msgpack/predef/os/android.h>
...
#if !MSGPACK_ENDIAN_BIG_BYTE && !MSGPACK_ENDIAN_BIG_WORD && \
    !MSGPACK_ENDIAN_LITTLE_BYTE && !MSGPACK_ENDIAN_LITTLE_WORD
#   include <rpcpp/msgpack/predef/architecture.h>
 ...
 */
    ...
    !MSGPACK_ENDIAN_LITTLE_BYTE && !MSGPACK_ENDIAN_LITTLE_WORD
#   if MSGPACK_ARCH_ARM
#       include <rpcpp/msgpack/predef/os/windows.h>
