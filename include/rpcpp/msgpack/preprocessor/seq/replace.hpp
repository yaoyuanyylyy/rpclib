...
# include <rpcpp/msgpack/preprocessor/comparison/equal.hpp>
# include <rpcpp/msgpack/preprocessor/control/iif.hpp>
# include <rpcpp/msgpack/preprocessor/seq/first_n.hpp>
# include <rpcpp/msgpack/preprocessor/seq/rest_n.hpp>
