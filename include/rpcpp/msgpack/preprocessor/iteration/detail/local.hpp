...
#        include <rpcpp/msgpack/preprocessor/iteration/detail/start.hpp>
#        define MSGPACK_PP_VALUE MSGPACK_PP_TUPLE_ELEM(2, 1, MSGPACK_PP_LOCAL_LIMITS)
#        include <rpcpp/msgpack/preprocessor/iteration/detail/finish.hpp>
...
#    include <rpcpp/msgpack/preprocessor/iteration/detail/rlocal.hpp>
# else
